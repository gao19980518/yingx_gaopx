...
public class AliyunOssUtil {
    ...
    private static String accessKeyId = "LTAI4GAs8nVdqE2UTMxUHgw1";
    private static String accessKeySecret = "CzInzGr4yi6vF81Vsqp8ANEfpeKiOC";
    private static String bucketName = "yingx-gaopx";
